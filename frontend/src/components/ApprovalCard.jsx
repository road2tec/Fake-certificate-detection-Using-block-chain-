...
import { CheckIcon, XMarkIcon, BuildingOfficeIcon, EnvelopeIcon, MapPinIcon, AcademicCapIcon } from '@heroicons/react/24/outline'
        ...
        >
            <div className="flex-1 space-y-6">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h3 className="font-bold text-2xl text-white tracking-tight">{manufacturer.name || 'Anonymous Institution'}</h3>
                        <div className="flex items-center gap-2 text-sm text-accent-pink font-bold uppercase tracking-widest mt-1">
                            <BuildingOfficeIcon className="w-4 h-4" />
                            {manufacturer.institution_name || manufacturer.company_name || 'Educational Institution'}
                        </div>
                    </div>
                </div>

                <div className="grid sm:grid-cols-2 gap-6 pl-1 text-gray-400">
                    <div className="flex items-center gap-3 text-sm font-medium group-hover:text-gray-300 transition-colors">
                    ...
                    <div className="flex items-center gap-3 text-sm font-medium group-hover:text-gray-300 transition-colors">
                        ...
                        {manufacturer.institution_address || manufacturer.company_address || 'Global Campus'}
                    </div>
                </div>
            </div>
